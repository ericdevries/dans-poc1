...
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.ARCHIS_NUMBER_ID;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.ARCHIS_NUMBER_TYPE;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.GRANT_NUMBER_AGENCY;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.GRANT_NUMBER_VALUE;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.OTHER_ID_AGENCY;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.OTHER_ID_VALUE;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.PUBLICATION_CITATION;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.PUBLICATION_ID_NUMBER;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.PUBLICATION_ID_TYPE;
import static nl.knaw.dans.poc.ddingest.service.DepositDatasetFieldNames.PUBLICATION_URL;
import static nl.knaw.dans.poc.depositmanager.XmlNamespaces.NAMESPACE_XSI;
...
public class Identifier extends Base {
    ...
    public static final CompoundFieldGenerator<Node> toOtherIdValue = (builder, node) -> {
        ...
        else if (!hasAttribute(node, NAMESPACE_XSI, "type")) {
